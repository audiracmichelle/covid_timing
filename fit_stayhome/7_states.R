...
model = rstan::stan_model("../7_states_concave.stan")
...
saveRDS(fit, "./models/7_states.rds")
...
saveRDS(fit2, "./models/7_states_mcmc.rds")
...
predicted = my_posterior_predict(fit, county_eval, type="stayhome", lag=14, states=TRUE, eval_pre = FALSE)
